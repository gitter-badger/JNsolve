...
function f(x,nameF,equationFit) {
    switch (nameF) {
        case 'linear':
             y = equationFit[0] * x + equationFit[1] ;
             break;
        case 'exponential':
            y = equationFit[0] * Math.exp(equationFit[1]*x) ;
            break;
        case 'logarithmic':
            y = equationFit[0] + equationFit[1]*Math.log(x) ;
            break;
        case 'law':
            y = equationFit[0]* Math.pow(x , equationFit[1]) ;
            break;
        case 'polynomial':
            y = equationFit[0] + equationFit[1] * x + equationFit[2] * x * x ;
            break;
        default:
            y =  equationFit[0] * x + equationFit[1] ;
            break;
