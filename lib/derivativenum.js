...
var linear_interpolation =  function (arraytointerpolate) {
...
var derivativenumericOpt =  function (f,npoints,interval) {
    var  x_n ,xpoints , h, h_n, a ,b , N, y_a, y_b, y_n, n, x_n_1, y_n_1 , df_dx = [];
    deltaInterpolacion = deltaInterpolacion || 'linear' ;
    sortInterval(interval) ;
    xpoints = deltax(npoints,interval, deltaInterpolacion).x_n_array ;
    N     = npoints ;
