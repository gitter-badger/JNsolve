...
var linear_interpolation =  function (arraytoextrapolate) {
    ...
    this.function_interpolated = function (x) {
      ...
      var beta = _arraytosearch[length-1] ;
      var N = length;
      var A = {}, B = {}, m, b ,n;
      if (x<a||x>b )  {return ;}
...
module.exports.linearinterrapolation  = linear_interpolation ;
...
var Nof =  function (f,npoints,interval) {
  interval = _.clone(interval,true) ;
    ...
    this.f_x = new  linear_extrapolation(array_of_derivative.dfdx_array).function_interpolated ;
};
